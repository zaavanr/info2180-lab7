...
class RequestForm(FlaskForm):
    ...
    driver=StringField('Driver Name(op)')
    vtype=SelectField('Vehicle Type', choices=[('Regular','Regular'),('Classy','Classy')])
    wfactor=SelectField('More Important',choices=[('Time','Time'),('Vehicle Type','Vehicle Type')])
